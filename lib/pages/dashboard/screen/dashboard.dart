...
class _DashboardPageState extends State<DashboardPage> {
  ...
  final List<Map<String, dynamic>> dashboardItems = [
    {"icon": Icons.add_circle_outlined, "title": "Add New Inquiry"},
    {"icon": FontAwesomeIcons.fileAlt, "title": "Inquiry Report"},
    {"icon": Icons.message_outlined, "title": "SMS Service"},
    {"icon": Icons.calendar_today_outlined, "title": "Fall Up"},
    {"icon": Icons.add_location, "title": "Branch"},
{"icon": Icons.person_add, "title": "User"},
  ];
