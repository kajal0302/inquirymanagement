                            ...
                            child: SizedBox(
                              ...
                              child: Card(
                                ...
                                shape: RoundedRectangleBorder(
                                    ...
                                    side:
                                        BorderSide(color: grey_400, width: 1)),
                                elevation: 1,
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CardRowWidget(
                                        ...
                                        iconValue: Icons.location_on_sharp),
                                    CardRowWidget(
                                        content: branch.contactNo!,
                                        iconValue: Icons.phone),
                                    CardRowWidget(
                                        content: branch.email!,
...
/// Widget for card rows
class CardRowWidget extends StatelessWidget {
  final String content;
  final IconData iconValue;

  const CardRowWidget(
      {super.key, required this.content, required this.iconValue});
